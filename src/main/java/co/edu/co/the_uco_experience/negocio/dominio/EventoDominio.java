package co.edu.co.the_uco_experience.negocio.dominio;
...
public class EventoDominio {
    ...
    public EventoDominio(final UUID id) {
        setId(id);
        setCodigoPublico("");
        setNombre("");
        setDescripcion("");
    ...
    public EventoDominio(final UUID id, final String codigoPublico, final String nombre, final String descripcion,
