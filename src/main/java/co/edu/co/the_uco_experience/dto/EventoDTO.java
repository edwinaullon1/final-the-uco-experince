package co.edu.co.the_uco_experience.dto;
...
public class EventoDTO {
    ...
    public EventoDTO(final UUID id) {
        setId(id);
        setCodigoPublico("");
        setNombre("");
        setDescripcion("");
    ...
    public EventoDTO(final UUID id, final String codigoPublico, final String nombre, final String descripcion,
